...
var _ commonIdMatcher = commonIdCosmosDBSqlRoleAssignment{}

type commonIdCosmosDBSqlRoleAssignment struct{}

func (c commonIdCosmosDBSqlRoleAssignment) ID() sdkModels.ResourceID {
	...
	return sdkModels.ResourceID{
		...
		Segments: []sdkModels.ResourceIDSegment{
			...
			sdkModels.NewStaticValueResourceIDSegment("sqlRoleAssignments", "sqlRoleAssignments"),
