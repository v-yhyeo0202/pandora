...
var _ commonIdMatcher = commonIdCosmosDBMongoMIRoleAssignment{}

type commonIdCosmosDBMongoMIRoleAssignment struct{}

func (c commonIdCosmosDBMongoMIRoleAssignment) ID() sdkModels.ResourceID {
	name := "CosmosDBMongoMIRoleAssignment"
