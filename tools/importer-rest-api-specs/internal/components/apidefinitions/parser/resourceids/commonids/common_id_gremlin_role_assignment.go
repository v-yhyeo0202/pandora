...
var _ commonIdMatcher = commonIdGremlinRoleAssignment{}

type commonIdGremlinRoleAssignment struct{}

func (c commonIdGremlinRoleAssignment) ID() sdkModels.ResourceID {
	name := "GremlinRoleAssignment"
